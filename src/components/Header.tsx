...
const Header = () => {
  ...
  if (
    ["/auth", "/dashboard"].includes(pathname || "") ||
            ...
            {user ? (
              ...
              <>
                <Link href="/auth">
                  <Button
                    variant="outline"
                    className="border-slate-300 text-slate-700 hover:bg-slate-50 hover:border-blue-300 hover:text-blue-600 transition-all duration-300 backdrop-blur-sm shadow-sm hover:shadow-md"
                  >
                    Login
                  </Button>
                </Link>
