...
const RocketIcon = () => (
  ...
  >
    <path
      d="M12.9989 3.38055L15.3771 5.75868C17.8026 8.18423 19.2295 9.89782 19.3616 11.9361C19.3857 12.3246 19.3857 12.7148 19.3616 13.1033C19.2295 15.1416 17.8026 16.8552 15.3771 19.2807L12.9989 21.6589"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M11.0011 21.6589L8.62301 19.2807C6.19745 16.8552 4.77051 15.1416 4.63843 13.1033C4.61423 12.7148 4.61423 12.3246 4.63843 11.9361C4.77051 9.89782 6.19745 8.18423 8.62301 5.75868L11.0011 3.38055"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M12 3.38055V7.07404"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M12 17.8892V21.5827"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    ...
    <path
      d="M15 9.49194L17.5 6.99194"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M9 9.49194L6.5 6.99194"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M15 15.4919L17.5 17.9919"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M9 15.4919L6.5 17.9919"
      stroke="#FF5733"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen bg-gradient-to-br from-white via-accent/20 to-white overflow-hidden"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-40">
        ...
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-aws-orange/20 to-gcp-red/20 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-gcp-yellow/20 to-secondary/20 rounded-full blur-2xl transform -translate-x-1/2 -translate-y-1/2 animate-float"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-24 pb-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            ...
            <div className="space-y-8">
              ...
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary/10 to-azure-blue/10 border border-primary/20 rounded-full text-sm font-semibold text-primary animate-fade-in shadow-sm">
                <Star
                  className="mr-2 h-4 w-4 fill-current text-amber-500"
                  strokeWidth={1.5}
                />
              ...
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-2">
                  ...
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
                    <span className="block bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent pb-1">
                      Transform
                    </span>
                    <span className="block bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent pb-2">
                      Your
                    </span>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mt-6 max-w-2xl">
                  Experience the most comprehensive cloud training program with
                  hands-on projects, expert mentorship, and guaranteed placement
                  support.
                </p>

                <div className="space-y-3 mt-6">
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed font-medium flex items-start text-gray-700">
                    <CheckCircle
                      className="mr-2 h-5 w-5 text-green-500 flex-shrink-0 mt-0.5"
                      strokeWidth={2}
                    />
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed font-medium flex items-start text-gray-700">
                    <CheckCircle
                      ...
                      strokeWidth={2}
                    />
                    <span>With 100% Placement Support</span>
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-square bg-gradient-to-br from-primary/5 via-azure-blue/5 to-aws-orange/5 rounded-3xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <div
                      className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-aws-orange to-gcp-red rounded-full opacity-20 animate-float"
                      style={{ animationDelay: "1s" }}
                    ></div>
                    <div
                      className="absolute -bottom-6 -left-6 w-20 h-20 bg-gradient-to-r from-azure-blue to-gcp-yellow rounded-full opacity-20 animate-float"
                      style={{ animationDelay: "2s" }}
                    ></div>
                  </div>
          ...
          <div className="flex flex-wrap gap-6 mt-16 sm:flex-row justify-between">
            ...
            <div
              className="flex-1 min-w-[250px] text-center p-8 
