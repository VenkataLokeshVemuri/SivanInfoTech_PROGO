...
export default function AdminLayout({
  ...
  const [activeNavContent, setActiveNavContent] = useState<string | null>(null);

  // Auto-reset to admin mode when on admin routes
  useEffect(() => {
    if (pathname?.includes('/admin/dashboard')) {
      setActiveNavContent(null);
    }
  }, [pathname]);
  ...
  // Content components for navbar sections
  const renderNavContent = () => {
    switch (activeNavContent) {
      case 'home':
        return (
          <div className="p-8">
    ...
    <div className="h-screen flex overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
          <button 
            onClick={() => setActiveNavContent(null)} 
          ...
          <div className="flex items-center justify-between h-20 px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-6">
              ...
              <nav className="hidden lg:flex items-center space-x-1">
                <button
                  onClick={() => setActiveNavContent('home')}
                  className={`relative px-4 py-2 text-slate-700 hover:text-blue-600 transition-all duration-300 font-medium text-sm rounded-lg group ${
                    activeNavContent === 'home' ? 'text-blue-600' : ''
                  }`}
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-lg transition-opacity duration-300 ${
                    activeNavContent === 'home' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}></div>
                  <div className={`absolute bottom-0 left-1/2 h-0.5 bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-300 ${
                    activeNavContent === 'home' ? 'w-3/4 left-1/8' : 'w-0 group-hover:w-3/4 group-hover:left-1/8'
                  }`}></div>
                </button>
                <button
                  onClick={() => setActiveNavContent('why-sitcloud')}
                  className={`relative px-4 py-2 text-slate-700 hover:text-blue-600 transition-all duration-300 font-medium text-sm rounded-lg group ${
                    activeNavContent === 'why-sitcloud' ? 'text-blue-600' : ''
                  }`}
                >
                  <span className="relative z-10">Why SitCloud</span>
                  <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-lg transition-opacity duration-300 ${
                    activeNavContent === 'why-sitcloud' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}></div>
                  <div className={`absolute bottom-0 left-1/2 h-0.5 bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-300 ${
                    activeNavContent === 'why-sitcloud' ? 'w-3/4 left-1/8' : 'w-0 group-hover:w-3/4 group-hover:left-1/8'
                  }`}></div>
                </button>
                <button
                  onClick={() => setActiveNavContent('courses')}
                  className={`relative px-4 py-2 text-slate-700 hover:text-blue-600 transition-all duration-300 font-medium text-sm rounded-lg group ${
                    activeNavContent === 'courses' ? 'text-blue-600' : ''
                  }`}
                >
                  <span className="relative z-10">Courses</span>
                  <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-lg transition-opacity duration-300 ${
                    activeNavContent === 'courses' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}></div>
                  <div className={`absolute bottom-0 left-1/2 h-0.5 bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-300 ${
                    activeNavContent === 'courses' ? 'w-3/4 left-1/8' : 'w-0 group-hover:w-3/4 group-hover:left-1/8'
                  }`}></div>
                </button>
                <button
                  onClick={() => setActiveNavContent('verify')}
                  className={`relative px-4 py-2 text-slate-700 hover:text-blue-600 transition-all duration-300 font-medium text-sm rounded-lg group ${
                    activeNavContent === 'verify' ? 'text-blue-600' : ''
                  }`}
                >
                  <span className="relative z-10">Verify Certificate</span>
                  <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-lg transition-opacity duration-300 ${
                    activeNavContent === 'verify' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}></div>
                  <div className={`absolute bottom-0 left-1/2 h-0.5 bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-300 ${
                    activeNavContent === 'verify' ? 'w-3/4 left-1/8' : 'w-0 group-hover:w-3/4 group-hover:left-1/8'
                  }`}></div>
                </button>
                <button
                  onClick={() => setActiveNavContent('contact')}
                  className={`relative px-4 py-2 text-slate-700 hover:text-blue-600 transition-all duration-300 font-medium text-sm rounded-lg group ${
                    activeNavContent === 'contact' ? 'text-blue-600' : ''
                  }`}
                >
                  <span className="relative z-10">Contact</span>
                  <div className={`absolute inset-0 bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-lg transition-opacity duration-300 ${
                    activeNavContent === 'contact' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}></div>
                  <div className={`absolute bottom-0 left-1/2 h-0.5 bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-300 ${
                    activeNavContent === 'contact' ? 'w-3/4 left-1/8' : 'w-0 group-hover:w-3/4 group-hover:left-1/8'
                  }`}></div>
                </button>
              </nav>
            </div>
