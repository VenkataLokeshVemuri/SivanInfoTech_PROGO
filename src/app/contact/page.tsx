  ...
  const officeLocations = [
    {
      ...
      address:
        "Old No: 6, New No: 10, Ground Floor\n2nd Street, Abiramapuram\nChennai, Tamil Nadu - 600018",
  ...
  const faqs = [
    {
      ...
      answer:
        "Basic computer knowledge and willingness to learn. We welcome students from all backgrounds.",
    },
    {
      question: "Do you provide placement assistance?",
      answer:
        "Yes, we have a dedicated placement team with 90%+ placement record and partnerships with 150+ companies.",
    },
    {
      question: "Are the courses industry-relevant?",
      answer:
        "All our courses are designed with industry experts and updated regularly to match current market demands.",
    },
    {
      question: "What is the class schedule?",
      answer:
        "We offer flexible timings - weekday batches, weekend batches, and online sessions to suit your schedule.",
    },
  ];
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative py-20 bg-gradient-to-br from-[#084fa1] via-[#1e40af] to-[#80b742] overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center text-white max-w-5xl mx-auto">
              <Badge
                variant="secondary"
                className="mb-6 text-[#084fa1] bg-white/90 backdrop-blur-sm"
              >
              ...
              <p className="text-xl md:text-2xl mb-8 text-white/90 leading-relaxed">
                Ready to transform your career? We're here to guide you every
                step of the way.
                <br />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 mt-12">
                {stats.map((stat, index) => (
                  ...
                  >
                    <stat.icon
                      className={`h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-2 ${stat.color.replace(
                        "text-",
                        "text-white"
                      )}`}
                    />
        ...
        <section className="py-12 sm:py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We have strategically located offices across major IT hubs in
                India to serve you better.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {officeLocations.map((office, index) => (
                <Card
                  key={index}
                  className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-blue-50 overflow-hidden"
                >
                  <CardHeader className="bg-gradient-to-r from-[#084fa1] to-[#80b742] text-white">
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <Badge
                        variant="secondary"
                        className="text-[#084fa1] bg-white"
                      >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <a
                          ...
                          className="text-[#80b742] hover:underline"
                        >
                          {office.phone}
                        </a>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <a
                          ...
                          className="text-[#084fa1] hover:underline"
                        >
                          {office.email}
                        </a>
                      </div>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Quick answers to questions you may have about our programs and
                services.
              </p>
            </div>
              ...
              <Card className="inline-block bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-4 justify-center">
                    ...
                    <Button
                      variant="outline"
                      className="border-[#084fa1] text-[#084fa1] hover:bg-[#084fa1] hover:text-white"
                    >
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                All our offices are strategically located near major
                transportation hubs for easy accessibility.
              </p>
            </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Thousand Lights Metro Station (2 mins walk)
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Multiple MTC bus routes available
                          </p>
                        </div>
                      </div>
        ...
        <section className="py-20 bg-gradient-to-br from-[#084fa1] via-[#1e40af] to-[#80b742] text-white overflow-hidden relative">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl md:text-2xl mb-12 text-white/90 max-w-4xl mx-auto leading-relaxed">
              ...
              their careers with Sivan InfoTech.
              <br />
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <Button
                  variant="secondary"
                  className="text-[#084fa1] hover:bg-white/90"
                >
                  <Phone className="h-4 w-4 mr-2" />
              ...
              <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <Button
                  variant="outline"
                  className="border-white/50 text-white hover:bg-white hover:text-[#084fa1]"
                >
                  <Calendar className="h-4 w-4 mr-2" />
                  Schedule Now
                </Button>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="bg-white text-[#084fa1] hover:bg-white/90 px-8 py-4 text-lg font-semibold"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/50 text-white hover:bg-white hover:text-[#084fa1] px-8 py-4 text-lg"
              >
